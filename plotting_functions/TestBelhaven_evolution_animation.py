...
CliffFile = "../driver_files/TestBelhavenCliffedCoast_Cliffline.xy"

CoastFile = "../driver_files/TestBelhavenCliffedCoast_Coastline.xy"

OutputFileName = "../driver_files/TestBelhavenCliffedCoast"
...
ymin = np.min(InitY)-200

ymax = np.max(InitY)+200
...
#            plt.plot(InitX[ii:ii+2],InitY[ii:ii+2],'k-',lw=1.5)
    ...
    plt.plot(CliffX,CliffY, 'k-', lw=1.5)

    plt.plot(CoastX,CoastY, '-', color=[0.8,0.8,0.5], lw=1.5)
