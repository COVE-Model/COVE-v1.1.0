...
CFLAGS= -g -c -Wall -pg -fopenmp  $(INCDIR)
LDFLAGS= -g -Wall -pg -fopenmp

# SOURCE FILES MACROS IN DEPENDENCY ORDER? SHOULDNT MATTER THANKS TO HEADERS
SOURCES = ./../coastline.cpp ./../waveclimate.cpp ./spiral_bay_scale_driver.cpp
...
# EXECUTABLE MACRO
EXECUTABLE=spiral_bay_scale.out
