...
int main(int argc, char* argv[])
{
	...
	double WaveTimeDelta = 0.05;					// Frequency at which to sample new waves (days)
	...
	string CliffInFile = "Spit_Cliffline_Points.xy";
	string CoastInFile = "Spit_Coastline_Points.xy";
	string FixedFileName = "Spit_Fixed_Cliffs.data";
	...
	//Wave climate 1
//	double OffshoreMeanWaveDirection1 = 290.;
//	double OffshoreStDWaveDirection1 = 20.;
//	double OffshoreMeanWavePeriod1 = 4.;
...
//	GaussianWaveClimate WaveClimate1(OffshoreMeanWavePeriod1,OffshoreStDWavePeriod1,OffshoreMeanWaveDirection1,OffshoreStDWaveDirection1,OffshoreMeanWaveHeight1, OffshoreStDWaveHeight1);
	...
	//Wave climate 2
	double OffshoreMeanWaveDirection2 = 340.;
	double OffshoreStDWaveDirection2 = 20.;
	double OffshoreMeanWavePeriod2 = 6.;
	double OffshoreStDWavePeriod2 = 1.;
	double OffshoreMeanWaveHeight2 = 1.0;
  ...
  //declare wave	
	...
	string WriteCoastFile = "SpitTest1CliffedCoast_Coastline.xy";
	string WriteCliffFile = "SpitTest1CliffedCoast_Cliffline.xy";
  ...
  CliffVector.SetLostFraction(LostFraction);
	...
	// Set the fraction of potential flux that can enter the model from the model boundaries	
	// In this case we're dealing with sediment coming around the northern headland
	double FluxFraction = 1.;
	CoastVector.SetFluxFraction(FluxFraction);
